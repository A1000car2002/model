...
<video controls width="640">
  <source src="labelst-VEED.mp4" type="video/mp4">
  Tu navegador no soporta el elemento <code>video</code>. Puedes descargar el video <a href="labelst-VEED.mp4">aquí</a>.
</video>
